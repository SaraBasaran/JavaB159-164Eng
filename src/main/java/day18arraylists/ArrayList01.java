...
public class ArrayList01 {
    ...
    public static void main(String[] args) {
        ...
        //Example 2: Type code to increase salaries in a list if the salary is less than 10000
        ...
        System.out.println(n);//[2, 3, 1, 2, 1]
        ...
        System.out.println(p);//[2, 3, 9]

        n.retainAll(p); //retainAll() keeps the common elements in the first list and it removes the different elements

        System.out.println(n);//[2, 3, 2]
