...
*/
    ...
    public static void startCalculation(){
        ...
        do {
            ...
            //if the term value is a valid value the app should go on for calculation
            //if not we should warn the user and ask the user to restart or exit
            if (term==1 || term==2){
                ...
                //if the payment is 0 or negative then print on the console "Incorrect data for calculation"
