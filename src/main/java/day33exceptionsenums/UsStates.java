...
public enum UsStates {
    ...
    /*
    Enums are used to store "constant data" that you need for your app. If you want to make your app workable by itself (standalone) you should create
    every single data in your app by yourself.
     */
